<div class="modal fade" id="insertarExperiencia">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="Ixp" class="form-horizontal" method="POST" onsubmit="return checkSubmitExperiencia();" action="PanelUsuario/InsertarExperiencia">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('puesto') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="puesto" type="text" class="form-control" name="puesto" value="{{ old('puesto') }}"  autofocus>
                    ...
                    <div class="form-group{{ $errors->has('funcion_realizada') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="funcion_realizada" type="text" class="form-control" name="funcion_realizada" value="{{ old('funcion_realizada') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('sector_empresa') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <select class="selectpicker form-control" id="sector_empresa" name="sector_empresa" value="{{ old('sector_empresa') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('mes_anyo_inicio') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="mes_anyo_inicio" type="text" class="form-control" name="mes_anyo_inicio" placeholder="mm-yyyy" value="{{ old('mes_anyo_inicio') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('mes_anyo_fin') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="mes_anyo_fin" type="text" class="form-control"  placeholder="mm-yyyy" name="mes_anyo_fin" value="{{ old('mes_anyo_fin') }}" required autofocus>
                    ...
                    <div class="form-group">
                        <div class="modal-footer">
                            <input type="submit" id="botonXp" class="btn btn-primary" value="Guardar">
                        </div>
                    </div>
                </div>
            </form>

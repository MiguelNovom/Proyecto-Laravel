<div class="modal fade" id="editarFormacion">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="PanelUsuario/EditarFormacion">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group{{ $errors->has('titulo') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <select class="selectpicker form-control" id="tituloE" name="titulo" value="{{ old('titulo') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('grado') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="gradoE" type="text" class="form-control" name="grado" value="{{ old('grado') }}" required autofocus>
                    ...
                    <div class="form-group{{ $errors->has('centro') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="centroE" type="text" class="form-control" name="centro" value="{{ old('centro') }}" required autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="finalizadoE" type="checkbox" class="form-check-input" name="finalizado" value="1" />
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('anyo_finalizacion') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="anyo_finalizacionE" type="text" class="form-control" name="anyo_finalizacion" value="{{ old('anyo_finalizacion') }}" required autofocus>
